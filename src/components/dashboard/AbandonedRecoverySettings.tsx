...
export function AbandonedRecoverySettings() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Mensagem de Recuperação - Abandonos</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Configure a mensagem para recuperar carrinhos abandonados e falhas.
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Olá {primeiro_nome}! Vi que você demonstrou interesse em nossos produtos..."
